...
if(isset($_POST['otp']) && !empty($_POST['otp']))
{
    ...
    $loan_status=(isset($_SESSION['mandate_o_status']['loan_status']))?$_SESSION['mandate_o_status']['loan_status']:'';
    $ecs_status=(isset($_SESSION['mandate_o_status']['ecs_status']))?$_SESSION['mandate_o_status']['ecs_status']:'';
    ...
    if (mysqli_num_rows($FetchDetailsQuery) > 0) {
        ...
        {   
            ...
            echo "true"; 
            /* $mandateDetailsResponse=getMandateDetails($_SESSION['mandate_o_status']['application_id'],$_SESSION['token']);
            ...
            if(!empty($mandateDetailsResponse))
            {
                ...
                if(isset($mandateDetails['achmandate_details']['error_code']) && ($mandateDetails['achmandate_details']['error_code']=='00' || $mandateDetails['achmandate_details']['error_code']=='01'))
                {    
                    $_SESSION['mandate_detail_shown']=true;
