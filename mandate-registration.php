...
if (!isset($_SESSION['mandate_r_applied'])) {
    $_SESSION['mandate_r_applied'] = false;
}

if (!isset($_SESSION['otp_r_generated'])) {
    $_SESSION['otp_r_generated'] = false;
}
    ...
    <div class="wrapper">
        ...
        <div class="container-fluid content">
			<div class="row">
				...
				<h2 class="bsh3">Registration of NACH Mandate</h2>
				<p class="hidden-xs">Home / Registration of NACH Mandate</p>
			</div>
		</div>
		...
		<div class="row">
			...
			if (!$_SESSION['mandate_r_applied']) {
				...
				<?php
			} elseif ($_SESSION['mandate_r_applied'] && !$_SESSION['otp_r_generated']) {
				$masked_mobileno = str_pad(substr($_SESSION['mandate_r_status']['mobile_number'], -4), strlen($_SESSION['mandate_r_status']['mobile_number']), 'X', STR_PAD_LEFT);
				// $masked_mobileno = substr_replace($_SESSION['mandate_r_status']['mobile_number'],"xxxxxxxx", 0,6);
				?>
				<div class="col-md-12 remove-select-arrow">
				...
				<?php
			} elseif ($_SESSION['mandate_r_applied'] && $_SESSION['otp_r_generated'] && (!isset($_SESSION['mandate_detail_shown']) || !$_SESSION['mandate_detail_shown'])) {
				?>
				<div class="errorDiv"></div>
				<div class="col-md-12 remove-select-arrow">
				<span class="mandetary-red otpFormDiv">* Indicates mandatory fields / * अनिवार्य क्षेत्र संकेत करता है</span>
				<form id="mandate_reg_otp_form" name="mandate_reg_otp_form" method="post">
				...
				<?php
			} elseif ($_SESSION['mandate_r_applied'] && $_SESSION['otp_r_generated'] && $_SESSION['mandate_detail_shown']) {
				?>
				<div class="errorDiv"></div>
				<div class="col-md-12 remove-select-arrow">
					<form id="mandate_reg_form" name="mandate_reg_form" method="post">
						...
						<p style="font-size: 12px; line-height: 24px">
							<input id="agreeCheck" name="agreeCheck" required style="display: inline; width: 20px; vertical-align: middle; height: 20px" type="checkbox" class="forminput" required /> Disclaimer : I/We hereby confirm that I/We would like to initiate E-mandate registration request of NACH for my/our home loan account with Aadhar housing finance limited (AHFL),
							I/We ensure that bank account details displayed on page is checked & confirmed by me/us.
							I hereby confirm that I am the Bank account holder of the bank and I am agreed to authenticate the Bank details to register the E-Mandate for monthly instalments (EMI/PEMI) payments.
							I/We also agreed and ensure that, I will never share my banking details like Net Banking login id & Debit card PIN CVV to anyone for e-mandate registration. 
							I/We also agreed and ensure that if e-mandate registration is not successful for any reason, I will provide physical mandate for NACH registration with full support to AHFL. 
							I/We, am/are is also aware that to adhere with the E-mandate registration request done by me/us, is at the sole discretion of AHFL.</p>
						</div>
						<div class="col-md-12">
			...
			?>
			<div class="col-md-12 remove-select-arrow">
				<p class="note">Note : Please do not share your Netbanking Log-in ID and passwords to anyone. Also do not share your debit card number, CVV and PIN Number.</p>
			</div>
				...
				<form id="disclaimer-form" data-parsley-validate>
					<div class="modal-content">
						<div class="modal-body">
							<p><img src="https://aadharhousing.com/img/logo.png" alt="Aadhar Housing Finance Ltd (AHFL)" class="center-block img-responsive" /></p>
							<p style="text-align: center; font-size: 24px;">ACH E-Mandate Registration</p>
							<p>Welcome to our <b>ACH E-Mandate</b> facility.You can now register for ACH E-Mandate online using the authentication of your bank&#39;s Net Banking log-in details or Debit Card PIN. This facility is available for Savings Bank accounts with selected Banks only.</p>
							<p>Kindly follow the below steps to register ACH E-Mandate with Aadhar Housing Finance Ltd(AHFL):</p>

							<p><b>STEP 1 : </b>Enter your 8-character AHFL’s Loan Application Number and Date of Birth for account verification with our record.</p>

							<p><b>STEP 2 : </b>Post validation, webpage will display Applicant’s Mobile Number with last four (4) digits. Kindly validate Mobile Number and click on Send OTP option. (Mobile number – XXXXXX1213)</p>

							<p><b>STEP 3 : </b> Enter OTP details on webpage to validate mobile number authentication.</p>

							<p><b>STEP 4 : </b>If your loan is active with AHFL, your bank details will be displayed on the webpage.</p>

							<p><b>STEP 5 : </b>Kindly check bank details & click on Submit button to proceed with mandate registration.</p>

							<p><b>STEP 6 : </b>If your bank is an ‘E-Mandate participative’ bank, E-Mandate option will get displayed on webpage with bank details which have been provided to AHFL.</p>

							<p><b>STEP 7 : </b>Kindly check the bank details and select authentication option via Net Banking or Debit Card. Accept terms & condition and proceed for authentication.</p>

							<p><b>STEP 8 : </b>Webpage will navigate to respective banking portal, where bank account holder will be prompted to enter required banking details for authentication.</p>

							<p><b>STEP 9 : </b>If banking authentication is successfully done, E-Mandate will get registered for monthly deduction of EMI.</p>

							<h4 class="mt-20"><b>Disclaimer : </b></h4>
							<ul>
								<li>This service is for Aadhar Housing Finance Limited (AHFL) customers only.</li>
								<li>ACH E-Mandate has to be issued from the Bank Account <strong>registered with AHFL,&nbsp;</strong>as Repayment Account for Monthly EMI payments. In case you want to change your bank account details, please visit the nearest AHFL Branch.</li>
								<li>New Bank details will be accepted only from applicant’s and co-applicant’s bank accounts.</li>
								<li>Mobile Number/Email Id registered with AHFL should be active for <strong>receiving the OTP for ACH Registration.</strong> You may contact any of AHFL Branch offices to update contact details if necessary.</li>
								<li>In the event you are unable to submit ACH registration request, you can re-try after 24 hours. If you still experience an issue, please write a mail to <a href="mailto:customercare@aadharhousing.com">customercare@aadharhousing.com</a> or contact us on 1800 3004 2020.</li>
								<li>Maximum Amount per mandate will be twice the EMI (i.e.,EMI X 2 ) or Rs10 Lakh whichever is lower. The &apos;maximum amount&apos; is to take care of changes in EMI during the term of the loan. However your account <strong>will normally be debited with 1 EMI per month.</strong></li>
								<li><strong>E-Mandate cannot be issued if&nbsp;</strong> your bank(i.e. the bank from which the E-Mandate is to be issued) is not registered with NPCI for API E-Mandate</li>
								<li><strong>Separate Physical NACH Mandate</strong>&nbsp;has to be submitted for each Loan Account.</li>
							</ul>
							<div class="form-check">
								<input class="form-check-input" type="checkbox" value="" name="agree" id="defaultCheck1" />
								<label class="form-check-label" for="defaultCheck1"> I agree to the above Terms & conditions.(Please tick) </label>
							</div>
...
<script src="https://aadharhousing.com/vendor/jquery.bxslider.js"></script>
	...
	$(document).ready(function () {
		...
		$('#mandate_reg_otp_form').validate({
            ...
            submitHandler: function(form) {
                ...
                //});
                $.ajax({ //make ajax request to cart_process.php
                    url: "ajaxVerifyMandateRegOTP.php",
                    type: "POST",
                    dataType:"html", // "json", //expect json value from server
                    data: $('#mandate_reg_otp_form').serialize()
                }).done(function(data) {
                    //on Ajax success
                    /* console.log(data);
                    console.log(typeof(data)); */
                    if (data == 'lsc') {
                        $('#loading').hide();
                        $('.errorDiv').html('Sorry! We could not process your request.<br/>Loan account mentioned is already closed. You may contact the nearest AHFL branch office.In case of any issue/query related to E-Mandate registration, you may contact Aadhar Housing Finance Ltd.');
                        $('#MandateVerifyBtn').remove();
                        $('.otpFormDiv').remove();
                        // mandetary-red
                        $('#MandateResetBtn').show();
                    ...
                    if (data == 'esa') {
                        $('#loading').hide();
                        $('.errorDiv').html('Sorry! We could not process your request.<br/>ACH Mandate already exists for your loan. You may contact our nearest branch office for details.<br/>In case of any issues/query related to E-Mandate registration you, may contact Aadhar Housing Finance Ltd.');
                        $('#MandateVerifyBtn').remove();
                        $('.otpFormDiv').remove();
                        $('#MandateResetBtn').show();
                    }
        ...
        $('#mandate_reg_form').validate({
            ...
            submitHandler: function(form) {
                ...
                //});
                $.ajax({ //make ajax request to cart_process.php
                    url: "ajaxMandateRegRequest.php",
                    type: "POST",
                    dataType:"json", // "json", //expect json value from server
                    data: $('#mandate_reg_form').serialize()
                }).done(function(data) {
                    // console.log(data);
                    ...
                    else if(data.status_code=='01')
                    {
                        $('#loading').hide();
                        // alert('Your request for Stop NACH mandate is generated sucessfully.');
                        $('.errorDiv').html('Something went wrong in generate data.Please try again later.');
                        // $('#MandateVerifyBtn').remove();
                        $('.otpFormDiv').remove();
                        $('#MandateResetBtn').show();
                    }
